...
require.register("actioncable/lib/assets/compiled/action_cable.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "actioncable");
  (function() {
    (function() {
  (function() {
    (function() {
...
require.register("breakfast-rails/lib/breakfast-rails.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "breakfast-rails");
  (function() {
    'use strict';

var LiveReloader = require('./live-reload');
...
var BreakfastRails = {
  init: function init() {
    ...
    var liveReloader = new LiveReloader(settings);
    var statusBar = new StatusBar(settings);
...
require.register("breakfast-rails/lib/live-reload.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "breakfast-rails");
  (function() {
    'use strict';
...
var RELOAD_CHANNEL = 'Breakfast::LiveReloadChannel';

var LiveReloader = function () {
  function LiveReloader(settings) {
    _classCallCheck(this, LiveReloader);

    this.settings = settings;
  }

  _createClass(LiveReloader, [{
    key: 'buildFreshUrl',
    value: function buildFreshUrl(url) {
    ...
    key: 'cssReload',
    value: function cssReload(strategy) {
      var _this = this;

      switch (strategy) {
        case 'hot':
          var reloadableLinkElements = window.top.document.querySelectorAll('link[rel=stylesheet]:not([data-no-reload]):not([data-pending-removal])');

          [].slice.call(reloadableLinkElements).filter(function (link) {
            return link.href;
          }).forEach(function (link) {
            return link.href = _this.buildFreshUrl(link.href);
          });
    ...
    key: 'jsReload',
    value: function jsReload(strategy) {
      switch (strategy) {
        case 'page':
          window.top.location.reload();
          break;
    ...
    key: 'htmlReload',
    value: function htmlReload(strategy) {
      switch (strategy) {
        case 'turbolinks':
    ...
    key: 'rubyReload',
    value: function rubyReload(strategy) {
      switch (strategy) {
        case 'turbolinks':
          var location = window.top.location;
    ...
    key: 'turbolinksAvailable',
    value: function turbolinksAvailable() {
    ...
    value: function init() {
      ...
      document.addEventListener('DOMContentLoaded', function () {
        _this2.settings.cable.subscriptions.create(RELOAD_CHANNEL, {
          received: function received(data) {
            var reloader = reloaders[data.extension];
            reloader(_this2.settings.strategies[data.extension]);
          }
        });
      });
    }
...
require.register("breakfast-rails/lib/settings.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "breakfast-rails");
  (function() {
    'use strict';
...
var LOCAL_STORAGE_KEY = 'breakfast-rails-settings';
...
var Settings = function () {
  ...
  _createClass(Settings, [{
    ...
    key: 'determineStrategies',
    value: function determineStrategies() {
      var defaults = this.options.strategies || {};
      var existing = this.storedSettings().strategies || {};

      return Object.assign(defaults, existing);
    }
  }, {
    key: 'updateStrategies',
    value: function updateStrategies(strategy) {
...
require.register("breakfast-rails/lib/status-bar.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "breakfast-rails");
  (function() {
    'use strict';
...
var STATUS_CHANNEL = 'Breakfast::StatusChannel';
  ...
  function StatusBar() {
    ...
    this.settings.cable.subscriptions.create(STATUS_CHANNEL, {
      connected: function connected() {
        _this.write(_this.settings.log.message, _this.settings.log.status);
      },
      received: function received(log) {
        if (_this.settings.strategies[log.extension] !== 'off') {
          _this.settings.updateLog(log);
          _this.write(log.message, log.status);
        }
      },
      disconnected: function disconnected() {
        _this.write('Disconnected from server...', 'error');
      }
    });
  }
  ...
  _createClass(StatusBar, [{
    ...
    value: function init() {
      ...
      document.addEventListener(eventName, function () {
        _this2.render();
        _this2.write(_this2.settings.log.message, _this2.settings.log.status);
      });
    ...
    key: 'write',
    value: function write(message, status) {
      var log = document.getElementById('breakfast-message-log');
      if (log) {
    ...
    value: function handleClick(option) {
      ...
      var reloaders = document.getElementById('breakfast-reloaders');
      reloaders.innerHTML = this.renderReloaders();
    }
  }, {
    key: 'render',
    value: function render() {
      var statusBar = document.getElementById('breakfast-status-bar');
    ...
    key: 'renderReloaders',
    value: function renderReloaders() {
    ...
    key: 'renderLink',
    value: function renderLink(type, strategy, text) {
      var active = this.settings.strategies[type] === strategy;
...
require.alias("actioncable/lib/assets/compiled/action_cable.js", "actioncable");
require.alias("breakfast-rails/lib/breakfast-rails.js", "breakfast-rails");
